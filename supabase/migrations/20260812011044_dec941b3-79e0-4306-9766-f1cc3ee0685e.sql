...
grant select, insert, update, delete on public.workout_log_sessions to authenticated;
grant all on public.workout_log_sessions to service_role;
...
grant select, insert, update, delete on public.workout_log_entries to authenticated;
grant all on public.workout_log_entries to service_role;
